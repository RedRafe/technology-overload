...
if not technology_overload_depths then
    technology_overload_depths = {}
end
if not technology_overload_fibonacci then
    technology_overload_fibonacci = {}
end
if not technology_overload_cumulative then
    technology_overload_cumulative = {}
end
T.cacheDepths()
